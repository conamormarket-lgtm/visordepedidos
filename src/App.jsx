...
function App() {
    ...
    return (
        ...
        >
            <div
                key={currentIndex}
                className={`flex flex-col w-full h-full border border-white/60 rounded-2xl overflow-hidden bg-white/40 backdrop-blur-sm shadow-xl transition-all duration-300 ${!currentOrder ? 'opacity-80' : ''} ${animDirection === 'right' ? 'animate-slide-in-right' : 'animate-slide-in-left'}`}
            >
